...
这篇[文章]([postProcessBeforeInstantiation()方法](https://blog.csdn.net/yerenyuan_pku/article/details/111413608#beanpostProcessBeforeInstantiation_11))讲的超详细，包含文字和debug的截图。
